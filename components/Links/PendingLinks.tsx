...
import {artistsPendingData} from '../dummydata/artistsPending';
import {userData} from '../dummydata/userData';
const {width, height} = Dimensions.get('window');

const PendingLinks: React.FC = () => {
  const [artists, setArtists] = useState(artistsPendingData);
    ...
    <View style={styles.artistResultContainer}>
      <View style={{display: 'flex', flexDirection: 'row'}}>
        <Image
          ...
          source={
            item.item.username === '@AdamDegross'
              ? require('../assets/AdamDegross.jpg')
              : item.item.username === '@PostMalone'
              ? require('../assets/Posty.jpg')
              : ''
          }
        />
